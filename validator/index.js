class Validator {
  ...
  equal(param) {
    if (this.param === undefined) return this;
    if (this.param !== param) this.errors = `${this.paramtitle} must be equal to ${param}`;
    return this;
  }
  ...
  min(minvalue) {
    let errormsg = "";
    if (this.param === undefined) return this;
    if (typeof this.param === "string" && this.param.length < minvalue) errormsg += `${this.paramtitle} must not be less than ${minvalue} characters`;
    if (typeof this.param === "number" && this.param < minvalue) errormsg += `${this.paramtitle} must not be less than ${minvalue}`;
  ...
  max(maxvalue) {
    let errormsg = "";
    if (this.param === undefined) return this;
    if (typeof this.param === "string" && this.param.length > maxvalue) errormsg += `${this.paramtitle} must not be greater than ${maxvalue} characters`;
    if (typeof this.param === "number" && this.param > maxvalue) errormsg += `${this.paramtitle} must not be greater than ${maxvalue}`;
    errormsg !== "" ? (this.errors = errormsg) : null;
    return this;
  }
  ...
  string() {
    if (this.param === undefined) return this;
    if (typeof this.param !== "string" || this.param.trim() === "") this.errors = `${this.paramtitle} must be of type string`;
    return this;
  }

  number() {
    if (this.param === undefined) return this;
    if (typeof this.param !== "number") this.errors = `${this.paramtitle} must be of type number`;
    return this;
  }
  ...
  error(errormsg) {
    errormsg === undefined || errormsg.trim() === "" || this.errors === null ? null : (this.errors = errormsg);
    return this;
  }
